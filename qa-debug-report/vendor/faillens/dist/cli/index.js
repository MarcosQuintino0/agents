...
async function main(args = process.argv.slice(2)) {
    ...
    if (command === "generate") {
        return (0, generate_1.generateCommand)({
    ...
    if (command === "run") {
        ...
        return (0, run_1.runCommand)(forwarded, process.cwd(), { open: faillensArgs.includes("--open") });
    }

import type { FactSource, FailLensContract, FailLensContractRule, FailLensFact, FailLensPersistenceEvidence, FailLensPersistenceExpectation } from "./provenance";
export type { FactSource, FailLensContract, FailLensFact, FailLensPersistenceEvidence, FailLensPersistenceExpectation, PersistenceEvidenceState, PersistenceExpectation, } from "./provenance";
export type RequestPhase = "preparacao" | "validacao" | "verificacao" | "limpeza" | "chamada";
...
export interface FailLensDiagnosis {
    category: "validation-not-applied" | "unhandled-validation-error" | "authorization-not-enforced" | "authentication-not-enforced" | "resource-not-found-mismatch" | "duplicate-conflict" | "success-expected-but-client-error" | "success-expected-but-server-error" | "persistence-mismatch" | "unexpected-persistence" | "network-error" | "timeout" | "schema-contract-mismatch" | "unknown";

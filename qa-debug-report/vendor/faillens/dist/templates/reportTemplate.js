...
const embeddedFont_1 = require("./embeddedFont");
...
const icon = (path) => `<span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24">${path}</svg></span>`;
...
<head>
  ...
  <style>${embeddedFont_1.embeddedFont}</style>
